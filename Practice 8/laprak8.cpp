...
//Destruktor queue Menghapus semua node.
template<class T> 
...
//fungsi mengembalikan element pertama antrian
template<class T>
T LinkedQueue<T>::First() const{
    if (IsEmpty()) throw OutOfBounds(); 
    return front->data;
}
//fungsi mengembalikan element terakhir antrian
template<class T>
T LinkedQueue<T>::Last() const{
    if (IsEmpty()) throw OutOfBounds(); 
    return rear->data;
}
//fungsi membuat node elemen baru
template<class T>
...
//fungsi menghapus pertama element antrian
template<class T>
